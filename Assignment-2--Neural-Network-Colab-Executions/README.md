# CMPE 258 — Assignment 2: Neural Network Colab Execution

This repository contains Google Colab notebooks for **CMPE 258 — Assignment 2**.  
...
### 1) `numpy_foundations_for_deep_learning.ipynb`
- **Youtube Video:** [Youtube Link](https://youtu.be/5KtPxhH95k4)
- **Colab Notebook:** [Colab Link](https://colab.research.google.com/drive/1SrHjzQPyq-jw2kDDPD4T8_Ffv6ExrC__?usp=sharing)

### 2) `pytorch_tensors_from_zero_to_hero.ipynb` --- [Colab 4]
...
- **Youtube Video:** [Youtube Link](https://youtu.be/-ekIrylh0ZY)
...
- **Youtube Video:** [Youtube Link](https://youtu.be/_3gzBGdEEBU)
...
### 9) `neural_networks_from_scratch.ipynb` --- [Colab 1]
